class PurchaseForm
  ...
  def save
    ...
    ActiveRecord::Base.transaction do
      # binding.pry
      @purchase.assign_attributes(user_id: user_id, shop_id: Shop.find_by(name: shop_name).id, bean_id: Bean.find_by(name: bean_name).id,
  ...
  def update
    ...
    ActiveRecord::Base.transaction do
      @purchase.update!(shop_id: Shop.find_by(name: shop_name).id, bean_id: Bean.find_by(name: bean_name).id,
                        store_roast_option: store_roast_option, store_grind_option: store_grind_option, purchase_at: purchase_at)
